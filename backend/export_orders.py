...
parser = argparse.ArgumentParser(description="Export Shopify orders.")
...
print("DEBUG: export_orders args -> start-date:", args.start_date, "end-date:", args.end_date)
...
with open(
    ...
    for order in all_orders:
        ...
        partnerCertId = order.get("partnerCertId") or {}
        sapCustomerId = order.get("sapCustomerId") or {}
...
print("Finance CSV exported successfully -> shopify_orders.csv")
