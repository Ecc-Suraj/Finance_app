...
# 1. Added "/api" to match the React generation request
@app.post("/partner-location-master")
...
# 2. Added "/api" to match the React download request
@app.get("/partner-location-master-download")
def download_partner_location_master():
