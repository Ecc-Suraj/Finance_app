...
def generate_ar_report(start_date=None, end_date=None):
    ...
    while True:
        ...
        print(f"Returned {len(orders)} orders from Shopify")
        for order in orders:
            print("--------------------------------")
            print("Order:", order["name"])
            print("Status:", order["displayFinancialStatus"])
    ...
    print(
        f"Total Orders Found: {len(all_orders)}"
    )
    ...
    with open(
        ...
        for order in all_orders:
            ...
            writer.writerow([
                ...
                assignPartnerType.get(
                    "value",
                    ""
                ),

                salesRepFullName.get(
                    "value",
                    ""
                ),

                salesRepOwnerCode.get(
                    "value",
                    ""
                ),
