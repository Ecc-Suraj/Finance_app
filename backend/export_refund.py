...
def format_date(date_string):
    """
    Convert Shopify datetime into DD-MM-YYYY.
    """
...
print(
    "Refund CSV exported successfully -> shopify_refunds.csv"
)
